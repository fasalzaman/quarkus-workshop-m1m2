...
----
mvn -q quarkus:add-extension -Dextensions="smallrye-health" -Duser.home=/home/jboss -f $CHE_PROJECTS_ROOT/quarkus-workshop-m1m2-labs
----
...
[source,sh,role=copypaste]
----
mvn -q quarkus:generate-config -Duser.home=/home/jboss -Duser.home=/home/jboss -f $CHE_PROJECTS_ROOT/quarkus-workshop-m1m2-labs
----
