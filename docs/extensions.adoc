...
==== IMPORTANT: The CodeReady Workspace will be loaded with the Project by default from Git branch and you can skip to **"Check out proper Git branch"** step. If you didn't find the project loaded by default you can continue with below steps to import project.
...
[source,sh,role="copypaste"]
----
mvn -q quarkus:list-extensions -Duser.home=/home/jboss -f $CHE_PROJECTS_ROOT/quarkus-workshop-m1m2-labs
----
