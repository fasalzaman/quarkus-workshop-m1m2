...
----
mvn -q quarkus:add-extension -Dextensions="jwt" -Duser.home=/home/jboss -f $CHE_PROJECTS_ROOT/quarkus-workshop-m1m2-labs
----
...
[source,sh,role="copypaste"]
----
mvn -q quarkus:add-extension -Dextensions="oidc, keycloak-authorization" -Duser.home=/home/jboss -f $CHE_PROJECTS_ROOT/quarkus-workshop-m1m2-labs
----
...
[source,sh,role="copypaste"]
----
mvn -q quarkus:remove-extension -Dextensions="jwt" -Duser.home=/home/jboss -f $CHE_PROJECTS_ROOT/quarkus-workshop-m1m2-labs
----
